...
class NewVisitorTest(LiveServerTestCase):
	...
	def test_can_start_a_list_and_retrieve_it_later(self):
		...
		#When he hits enter, page goes to a new URL and the page now lists
		...
		#New user comes on the page, Francis
		
		##New browser session is opened to make sure no information
		##of Jacks is coming through cookies
		self.browser.quit()
		self.browser = webdriver.Firefox()
		
		#Francis visists the home page, there is no sign of Ediths list
		self.browser.get(self.live_server_url)
